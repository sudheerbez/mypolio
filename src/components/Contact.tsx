  ...
  return (
    <section className="section border-t border-dark-gray/60 bg-pure-black py-24" id="contact">
      <div className="container mx-auto px-4">
        <ScrollReveal className="max-w-4xl space-y-4" direction="up" duration={0.7}>
        ...
        <StaggerContainer className="mt-10 grid gap-6 md:grid-cols-2" staggerDelay={0.15}>
          {channels.map(({ icon: Icon, title, description, action, href }) => (
            <StaggerItem key={title} direction="up" distance={35} duration={0.55}>
              <a
                href={href}
